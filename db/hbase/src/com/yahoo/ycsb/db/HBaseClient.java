...
public class HBaseClient extends com.yahoo.ycsb.DB
{
  ...
  public static final String defaultTableName = "usertable";
  public static final String defaultFCName = "family";
  ...
  public void init() throws DBException
  {
    ...
    // create table
    try {
      this.createTable(Bytes.toBytes(defaultTableName),
        Bytes.toBytes(defaultFCName));
    }
    catch (Exception e) {
